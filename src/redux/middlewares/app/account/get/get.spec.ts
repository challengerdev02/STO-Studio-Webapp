...
import { getAccountMe as getAccountMiddleware } from './index';
import { APP_URL, GET } from '../../../../../_shared/constants';

jest.mock('../../../../actions/app/api');

describe('Get Account: Get Account Test', function () {
  ...
  beforeEach(() => {
    ...
    mockedRedux.getAccountAction = getAccountMiddleware(mockedRedux.store)(
  ...
  it('should dispatch the getAccount actions, then apiRequest action with correct parameters', () => {
    ...
    expect(serverRequest).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        onSuccess: '@@account/get_account_SUCCESS',
        ...rest,
      })
    );
    // Dispatch action
