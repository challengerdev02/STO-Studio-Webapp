...
export const TokenAssetContainer = () => {
  ...
  //   if (toBN(data).gtn(0)) {
  //
  //     findOneAccount({ params: { walletAddress }, uiKey: findAccountUIKey });
  //   }
  // };
  // const onGetTokenOwner = () => {
  //   bookContractCall('balanceOf', { onFinish: onOwnerOfFinish, uiKey: findAccountUIKey }, ownerAddress, tokenID);
  // };
  ...
  const blockchainAssetMetadata = {
    ...
    description: get(resource, [TokenAssetContainerKey, 'description'], []),
