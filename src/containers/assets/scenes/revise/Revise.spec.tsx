...
import { ReviseSceneContainer } from './index';
...
describe('View Book Container', function () {
  afterEach(cleanup);
  beforeEach(() => {
  ...
  it('should match with snapshot', () => {
    // @ts-ignore
    const { container } = render(<ReviseSceneContainer />);
  ...
  it('should try to submit Revise', async () => {
    // @ts-ignore
    const { container } = render(<ReviseSceneContainer assetDomain="revise" />);
