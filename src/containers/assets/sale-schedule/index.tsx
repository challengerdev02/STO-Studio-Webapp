...
export const SaleScheduleContainer = (props: SaleScheduleContainerProps) => {
  ...
  //       instance({
  //         method: 'get',
  //         url: `/sale-options/get-asset/${tokenHash}/${tokenID}/${values.blockchain ?? chainId
  //           }`,
  //         data: null,
  //         params: null,
  //         isExternal: true,
  ...
  const onScheduleSale = async ({ price, recipient }: any) => {
    ...
    psbt.addOutput({
      ...
      value: Number((Number(price) * 100000000).toFixed(0)),
    });
