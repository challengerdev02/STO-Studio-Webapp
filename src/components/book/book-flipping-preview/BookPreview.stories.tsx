...
import { BookFlippingPreview } from './index';
import { SceneNamespace } from '@/shared/namespaces/scene';
import { UserNamespace } from '@/shared/namespaces/user';

export default {
  title: 'book/preview',
  component: BookFlippingPreview,
} as ComponentMeta<typeof BookFlippingPreview>;
const images = [
...
const Template: ComponentStory<typeof BookFlippingPreview> = (args) => (
  <BookFlippingPreview
    {...args}
    title="xxxxxxx"
